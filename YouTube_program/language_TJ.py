...
def analyze_and_split_all_videos(channel_id):
    ...
    df_shorts.to_csv('TJ_shorts_language_analysis.csv', index=False, encoding='utf-8-sig')
    df_regular.to_csv('TJ_regular_language_analysis.csv', index=False, encoding='utf-8-sig')
